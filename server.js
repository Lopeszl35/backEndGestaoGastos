...
const loadDependencies = async () => {
  try {
    ...
    const { configurarRelacionamentosModelos } = await import(
    ...
    // Registro de cartoes
    const { CartoesRepositorioORM } = await import(
      "./modules/cartoes/repositories/CartoesRepositorioORM.js"
    );
    const { CartaoFaturasRepositorioORM } = await import(
      "./modules/cartoes/repositories/CartaoFaturasRepositorioORM.js"
    );
    const { CartaoLancamentosRepositorioORM } = await import(
      "./modules/cartoes/repositories/CartaoLancamentosRepositorioORM.js"
    );
    const { CartoesService } = await import(
      "./modules/cartoes/CartoesService.js"
    );
    const { CartoesController } = await import(
      "./modules/cartoes/CartoesController.js"
    );

    DependencyInjector.register(
      "CartoesRepositorioORM",
      new CartoesRepositorioORM()
    );
    DependencyInjector.register(
      "CartaoFaturasRepositorioORM",
      new CartaoFaturasRepositorioORM()
    );
    DependencyInjector.register(
      "CartaoLancamentosRepositorioORM",
      new CartaoLancamentosRepositorioORM()
    );
    ...
    const { default: UserRepository } = await import(
      "./modules/usuario/userRepository.js"
    );
    ...
    DependencyInjector.register(
      ...
      new CategoriasRepository(database)
    );
    console.log("CategoriasRepository registrado com sucesso.");

    const { default: GastosFixosRepository } = await import(
      "./modules/gastos_fixos/GastosFixosRepository.js"
    );
    DependencyInjector.register(
      "GastosFixosRepository",
      new GastosFixosRepository(database)
    );
    console.log("GastosFixosRepository registrado com sucesso.");

    const { default: GastoMesRepository } = await import(
      "./modules/gastos/GastoMesRepository.js"
    );
    DependencyInjector.register(
      "GastoMesRepository",
      new GastoMesRepository(database)
    );
    ...
    DependencyInjector.register(
      "AlertasRepository",
      new AlertasRepository(database)
    );

    const { default: NotificacoesService } = await import(
      "./modules/alertas/NotificacoesService.js"
    );
    DependencyInjector.register(
      "NotificacoesService",
      new NotificacoesService()
    );

    // Registro de Services
    const { default: UserService } = await import(
      "./modules/usuario/UserService.js"
    );
    DependencyInjector.register(
      "UserService",
      new UserService(DependencyInjector.get("UserRepository"))
    );
    ...
    DependencyInjector.register(
      "CategoriasService",
      new CategoriasService(DependencyInjector.get("CategoriasRepository"))
    );
    console.log("CategoriasService registrado com sucesso.");

    const { default: GastoMesService } = await import(
      "./modules/gastos/GastoMesService.js"
    );
    DependencyInjector.register(
      "GastoMesService",
      new GastoMesService(
    ...
    const { default: GastosFixosService } = await import(
      "./modules/gastos_fixos/GastosFixosService.js"
    );
    DependencyInjector.register(
      "GastosFixosService",
      new GastosFixosService(DependencyInjector.get("GastosFixosRepository"))
    );
    ...
    const { default: GastoMesController } = await import(
      "./modules/gastos/GastoMesController.js"
    );
    DependencyInjector.register(
      "GastoMesController",
      new GastoMesController(
        DependencyInjector.get("GastoMesService"),
        DependencyInjector.get("TransactionUtil")
      )
    );

    const { default: GastosFixosController } = await import(
      "./modules/gastos_fixos/GastosFixosController.js"
    );
    DependencyInjector.register(
      "GastosFixosController",
      new GastosFixosController(DependencyInjector.get("GastosFixosService"))
    );
...
const initializeServer = async () => {
  try {
    ...
    // Rotas para teste
    const { default: routerTest } = await import(
      "./modules/routes/routerTest.js"
    );
    app.use(routerTest);

    // Registro das Rotas
    const { default: UserRoutes } = await import(
      "./modules/usuario/UserRoutes.js"
    );
    ...
    const { default: GastoMesRoutes } = await import(
      "./modules/gastos/GastoMesRoutes.js"
    );
    const gastoMesController = DependencyInjector.get("GastoMesController");

    const { default: GastosFixosRoutes } = await import(
      "./modules/gastos_fixos/GastosFixosRoutes.js"
    );
    const gastosFixosController = DependencyInjector.get(
      "GastosFixosController"
    );

    const { default: CartoesRoutes } = await import(
      "./modules/cartoes/CartoesRoutes.js"
    );
    ...
    app.use(
      "/api/",
      CartoesRoutes(DependencyInjector.get("CartoesController"))
    );
...
async function testDatabaseConnection() {
  try {
    ...
    console.log(
      "Conexão com o banco de dados estabelecida com sucesso. Sua solução é:",
      result
    );
  } catch (error) {
    console.error(
