...
export default (categoriasController) => {
  router.post("/criarCategoria/me", verifyToken, validateCreateCategoria, (req, res, next) => {
    categoriasController.createCategorias(req, res, next);
  });

  router.get("/getCategoriasAtivas/me", verifyToken, validateGetCategorias, (req, res, next) => {
    categoriasController.getCategoriasAtivas(req, res, next);
  });

  router.get("/getCategoriasInativas/me", verifyToken, (req, res, next) => {
    categoriasController.getCategoriasInativas(req, res, next);
  });

  router.delete("/deleteCategorias/id_categoria", verifyToken, validateDeleteCategoria, (req, res, next) => {
  ...
  router.patch("/updateCategoria/id_categoria", verifyToken, validateUpdateCategoria, (req, res, next) => {
